...
System.register(['app/plugins/sdk', 'lodash', 'app/core/utils/kbn', 'app/core/time_series', './rendering', './legend'], function (_export, _context) {
  ...
  var MetricsPanelCtrl, _, kbn, TimeSeries, rendering, legend, _createClass, SankeyCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('SankeyCtrl', SankeyCtrl = function (_MetricsPanelCtrl) {
        _inherits(SankeyCtrl, _MetricsPanelCtrl);

        function SankeyCtrl($scope, $injector, $rootScope) {
          _classCallCheck(this, SankeyCtrl);

          var _this = _possibleConstructorReturn(this, (SankeyCtrl.__proto__ || Object.getPrototypeOf(SankeyCtrl)).call(this, $scope, $injector));
      ...
      _export('SankeyCtrl', SankeyCtrl);

      SankeyCtrl.templateUrl = 'module.html';
    }
  };
});
//# sourceMappingURL=sankey_ctrl.js.map
